        ...
        <div class="lg:col-span-2">
          ...
          <div class="flex space-x-4">
            <a
              ...
              :key="social.name"
              :href="social.url"
              class="w-10 h-10 bg-gray-700 hover:bg-gradient-to-br hover:from-sky-500 hover:to-teal-500 rounded-lg flex items-center justify-center transition-all duration-300 transform hover:scale-110"
            >
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li>
              ...
              >
                <span class="w-1 h-1 bg-sky-400 rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                Home
              </router-link>
            </li>
            <li v-if="route.path === '/'">
        ...
        <div>
          ...
          <div class="space-y-4">
            <div class="flex items-start space-x-3">
              <div class="w-6 h-6 bg-sky-500/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-1">
            ...
            <div class="flex items-center space-x-3">
              <div class="w-6 h-6 bg-sky-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
                <svg class="w-4 h-4 text-sky-400" fill="currentColor" viewBox="0 0 20 20">
