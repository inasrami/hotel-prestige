<template>
  <footer class="bg-primary text-gray-300">
    <div class="w-4/5 mx-auto py-16 grid gap-10 grid-cols-1 md:grid-cols-4">
      <div>
        <h3 class="font-serif text-2xl text-white mb-2">Hotel Prestige</h3>
        <p class="text-gray-400">Luxury Redefined</p>
      </div>

      <div>
        <h4 class="font-serif text-xl text-white mb-4">Links</h4>
        <ul class="space-y-2">
      ...
      <div>
        <h4 class="font-serif text-xl text-white mb-4">Contact</h4>
      ...
      <div>
        <h4 class="font-serif text-xl text-white mb-4">Social</h4>
    ...
    <div class="border-t border-gray-800">
      <div class="w-4/5 mx-auto py-6 text-center text-sm text-gray-400">
        <p>&copy; 2025 Hotel Prestige. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template>
