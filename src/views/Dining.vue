      ...
      <div class="container-custom">
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            From fine dining to casual elegance, discover culinary journeys that delight every palate
          </p>
        </div>
        ...
        <div class="space-y-16">
          ...
          >
            ...
            >
              <div class="space-y-6">
                <div>
                  <h3 class="font-serif text-3xl font-bold text-gray-900 mb-2">{{ restaurant.name }}</h3>
                  <p class="text-sky-600 font-semibold">{{ restaurant.cuisine }}</p>
                </div>
                ...
                <div class="space-y-3">
                  ...
                  <div class="flex flex-wrap gap-2">
                    <span
                      ...
                      :key="dish"
                      class="px-3 py-1 bg-sky-100 text-sky-700 rounded-full text-sm font-medium"
                    >
                      {{ dish }}
                    </span>
                  </div>
          ...
          >
            ...
            <div class="p-6">
              <div class="flex justify-between items-start mb-3">
                ...
                <span class="text-lg font-bold text-sky-600">${{ dish.price }}</span>
              </div>
              <p class="text-gray-600 text-sm mb-4">{{ dish.description }}</p>
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded-full">{{ dish.category }}</span>
...
const restaurants = [
  {
    ...
    description: 'Our flagship restaurant offers an exquisite fine dining experience with innovative European cuisine crafted from the finest local and international ingredients.',
  ...
  },
  {
    ...
    description: 'Enjoy casual elegance with stunning views of Prizren. Our bistro celebrates Mediterranean flavors with authentic Kosovo specialties.',
  ...
  },
  {
    ...
    description: 'Our rooftop lounge offers craft cocktails and artisanal small plates with panoramic views of the historic city.',
